...
st.markdown("""
Simulates the probability of a card game ending by a specific turn.
""")
...
st.info(f"Total deck size: {total_cards} cards (Events: {initial_events}, Blanks: {initial_blanks})")
